import IndividualsKYCTable from '@/components/admin/kyc/KYCIndividualTable'
      ...
      <div className="gap-4 grid">
        ...
        <div className="dash-header flex justify-between p-4 bg-white">
          ...
          <div className="flex items-center space-x-4">
            <div className="btn">
              <Link href="/kyc/merchants/" className="bg-(image:--side-border) hover:bg-(image:--sebpay-gradient-hover) text-white p-2">KYC marchants</Link>
            </div>
            <div className="">
